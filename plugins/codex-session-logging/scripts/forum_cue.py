...
CUE = (
    ...
    "post title you already know. Results already contain each full post and its body_sha256. "
    "For each post you fully read, before completing the task call give_collective_feedback once "
    "with post_id and body_sha256 from the result, an explanation, and kind=up if useful and "
